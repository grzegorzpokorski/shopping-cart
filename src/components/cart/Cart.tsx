...
export const Cart = ({ cartIsOpen }: CartProps) => {
  return (
    <>
      ...
      <div
        className={cn(
          "fixed right-0 bottom-0 z-10 max-w-xs md:max-w-md lg:max-w-lg w-full p-8 lg:p-0 flex flex-col gap-6 overflow-y-auto bg-white shadow-md transition duration-300 ease-in-out top-16 lg:top-20 border-t-2 border-zinc-200",
